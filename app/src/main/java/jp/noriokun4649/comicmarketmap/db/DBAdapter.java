 ...
 */
abstract class DBAdapter extends RealmBaseAdapter<DBObject> implements ListAdapter {
     ...
     * @param data DBの内容
     */
    public DBAdapter(@Nullable final OrderedRealmCollection<DBObject> data) {
        super(data);
    }
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        colorButton.setText(getColorText());
        memoButton.setText(getMemoText());
    ...
    abstract int getMemoText();

    abstract int getColorText();
}
